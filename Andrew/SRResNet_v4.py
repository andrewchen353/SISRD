...
def createModel():
    ...
    conv5 = Conv2D(4, (3, 3), padding='same', activation='relu')(add2) # v1, 10 epochs
    spc1 = SubpixelConv2D(conv5.shape, scale=2)(conv5)
    conv6 = Conv2D(1, (3, 3), padding='same', activation='relu')(spc1) # v3, 40 epochs

    model = Model(x_input, conv6)
