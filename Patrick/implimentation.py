...
def main():
	...
	model = model64()
	model.fit(training_input, training_output, batch_size=64, epochs=1, validation_split=0.15)
	intermidiate_train_input = model.predict(training_input)
	print('startint to load test')
